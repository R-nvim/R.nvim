...
M.create = function(mode, plug, combo, target)
  ...
  if mode:find('n') then
    ...
    if
      not cfg.user_maps_only and vim.fn.hasmapto('<Plug>' .. plug, 'n') == 0
    then
      vim.api.nvim_buf_set_keymap(
        0,
        'n',
  ...
  if cfg.insert_mode_cmds and mode:find('i') then
    ...
    if
      not cfg.user_maps_only and vim.fn.hasmapto('<Plug>' .. plug, 'i') == 0
    then
      vim.api.nvim_buf_set_keymap(
        0,
        'i',
...
M.control = function()
  ...
  M.create(
    ...
    'RClearConsole',
    'rr',
    ':lua require("r.term").clear_console()'
  )
  M.create('nvi', 'RClearAll', 'rm', ':lua require("r.term").clear_all()')
...
M.start = function()
  ...
  M.create(
    ...
    'RCustomStart',
    'rc',
    ':lua require("r.run").start_R("custom")'
  )
...
M.edit = function()
  ...
  if cfg.assign then
    vim.api.nvim_buf_set_keymap(
      ...
      'i',
      cfg.assign_map,
      '<Esc>:lua require("r.edit").assign()<CR>a',
      { silent = true }
    )
  end
end
...
M.send = function()
  ...
  M.create(
    ...
    'RSendFunction',
    'ff',
    ':lua require("r.send").fun("silent", "stay")'
  )
  ...
  M.create(
    ...
    'RDSendFunction',
    'fe',
    ':lua require("r.send").fun("echo", "stay")'
  )
  ...
  M.create(
    ...
    'RDSendFunction',
    'fd',
    ':lua require("r.send").fun("silent", "down")'
  )
  ...
  M.create(
    ...
    'RDSendFunction',
    'fa',
    ':lua require("r.send").fun("echo", "down")'
  )
  ...
  M.create(
    ...
    'RSendSelection',
    'ss',
    ':call SendSelectionToR("silent", "stay", "normal")'
  )
  ...
  M.create(
    ...
    'RESendSelection',
    'se',
    ':call SendSelectionToR("echo", "stay", "normal")'
  )
  ...
  M.create(
    ...
    'RDSendSelection',
    'sd',
    ':call SendSelectionToR("silent", "down", "normal")'
  )
  ...
  M.create(
    ...
    'REDSendSelection',
    'sa',
    ':call SendSelectionToR("echo", "down", "normal")'
  )
  ...
  M.create(
    ...
    'REDSendSelection',
    'sa',
    ':call SendSelectionToR("echo", "down")'
  )
  ...
  M.create(
    ...
    'so',
    ':call SendSelectionToR("echo", "stay", "NewtabInsert")'
  )
  ...
  M.create(
    ...
    'RSendParagraph',
    'pp',
    ':lua require("r.send").paragraph("silent", "stay")'
  )
  ...
  M.create(
    ...
    'RESendParagraph',
    'pe',
    ':lua require("r.send").paragraph("echo", "stay")'
  )
  ...
  M.create(
    ...
    'RDSendParagraph',
    'pd',
    ':lua require("r.send").paragraph("silent", "down")'
  )
  ...
  M.create(
    ...
    'REDSendParagraph',
    'pa',
    ':lua require("r.send").paragraph("echo", "down")'
  )
  ...
  M.create(
    ...
    '(RDSendLineAndInsertOutput)',
    'o',
    ':call RWarningMsg("This command does not work over a selection of lines.")'
  )
  M.create(
    'i',
    'RSendLAndOpenNewOne',
    'q',
    ':lua require("r.send").line("newline")'
  )
  ...
  M.create(
    ...
    'RNLeftPart',
    'r<left>',
    ':lua require("r.send").line_part("left", 0)'
  )
  M.create(
    'n',
    'RNRightPart',
    'r<right>',
    ':lua require("r.send").line_part("right", 0)'
  )
  M.create(
    'i',
    'RILeftPart',
    'r<left>',
    ':lua require("r.send").line_part("left", 1)'
  )
  M.create(
    'i',
    'RIRightPart',
    'r<right>',
    ':lua require("r.send").line_part("right", 1)'
  )
