...
local do_common_global = function()
    ...
    local first_line = "Last change in this file: 2024-03-03"
    if
    ...
    if need_readme then
        ...
        local readme = {
            ...
            "The objls_, args_, and the inst_libs are used for auto completion and to",
            "fill the Object Browser. They will be regenerated if you either delete",
            "them or delete this README file.",
            "",
