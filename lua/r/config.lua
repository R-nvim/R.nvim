...
local check_readme = function()
    ...
    if need_readme then
        ...
        local readme = {
            ...
            "The objls_, args_, and alias_ files are used for auto completion and",
            "to fill the Object Browser. They will be regenerated if you either",
            "delete them or delete this README file.",
            "",
