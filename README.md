...
> replaced with a built-in language server. If you experience problems, please,
> report the bugs that you have found, and configure your plugin manager to
> use the version `0.99.1` of `R.nvim`.
